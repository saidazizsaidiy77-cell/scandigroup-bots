...
const App = (() => {
  ...
  const PAGES = [
    ...
    { href: '/harakat.html', mod: 'production', nav: "Bo'limlar aro harakat",
      ...
      text: "Konverlar bo'limlar bo'yicha \u00b7 bitta bosishda keyingi bo'limga \u00b7 keyingi tsexga topshirishga qancha qolgani",
    ...
    { href: '/nazorat.html', mod: 'production', nav: 'Bugungi harakatlar',
      title: 'Bugungi harakatlar', lead: 'Kim nima kiritdi',
      text: "Kunlik lenta: xodim, konveyer, qayerdan qayerga \u00b7 brak \u00b7 Excelga yuklash",
      perm: ['production.view'] },
